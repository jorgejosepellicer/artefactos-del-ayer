...
class NgxPaypalComponent {
    ...
    initPayPal(config, paypal) {
        ...
        this.ngZone.runOutsideAngular(() => {
            ...
            const buttonsConfig = Object.assign(Object.assign(Object.assign({ style: config.style, fundingSource: undefined, onApprove: (data, actions) => {
                    return this.ngZone.run(() => {
                        if (config.onApprove) {
            ...
            if (fundSource != undefined) {
                ...
                if (config.fundingSource !== "PAYPAL")
                    (_a = buttonsConfig.style) === null || _a === void 0 ? true : delete _a.color;
            }
